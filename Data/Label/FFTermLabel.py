from .AtomType.BaseAtomType import BaseAtomType
...
class FFTermLabel:
    def __init__(self,keyElements,LabelType = BaseAtomType):
        self._Label = LabelType
    ...
    def fromString(cls,string):
        """
        Construct term label instances from strings
        like "a-b-c-d"
        """
