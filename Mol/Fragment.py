...
from .Mixins.DumpLoad import DumpLoadMixin as DLMixin
from .OBInterface.OBMolConverter import OBMolConverter
from .OBInterface.OBSmartSearcher import OBSMARTSearcher

from .FragView import FragView
from .MolGraphIter import BFSFloodMGIter



class Fragment(DLMixin):
    """
    ...
    def subFrag(self,indices):
        ...
        newFrag = Fragment(newEXYZ,newCharges)
        return newFrag

    def subView(self,indices):
        sView = FragView(self,indices)
        return sView
    ...
    def components(self):
        for component in self.molgraph.components:
            yield FragView(self,list(component))
    ...
    def matchFrag(self,otherFrag,startSmi = None):
        ...
        selfFloodIter = BFSFloodMGIter(self.molgraph,selfStIndices)
        otherFloodIter = BFSFloodMGIter(otherFrag.molgraph,otherStIndices)
