...
if TYPE_CHECKING:
    from .STMolGraph import STMolGraph
    
class STSerialMGIter:
    def __init__(self,parent : STMolGraph):
        self.parent = parent
...
class STBFSFloodMGIter:
    """
        A custom bfs iterator over nodes of STMolGraph
